...
<tileset version="1.5" tiledversion="1.7.2" name="outdoors" tilewidth="16" tileheight="16" tilecount="288" columns="24">
 <image source="../tilesets/outdoor.png" width="384" height="192"/>
 <tile id="6" probability="0.2"/>
 <tile id="30" probability="0.2"/>
 <tile id="54" probability="0.2"/>
 <tile id="78" probability="0.2"/>
 <tile id="102" probability="0.2"/>
 <tile id="126" probability="0.2"/>
 <wangsets>
  <wangset name="outdoors" type="corner" tile="-1">
